...
\title{Aprendizaje automático orientado a la clasificación de cáncer de pielÑ un enfoque basado en EfficientNetB1}
\author{\\\vspace{0.25cm}Deborah Famadas Rodríguez}
\advisor{\\\vspace{0.25cm}Dr. Reinaldo Rodríguez Ramos\\\vspace{0.2cm}Dr. Yudivian Almeida}
