...
\advisor{\\\vspace{0.25cm}Prof. Reinaldo Rodríguez Ramos$^{*}$ \\\vspace{0.2cm}Dr. Yudivian Almeida Cruz \\\vspace{0.5cm}Universidad de la Habana,\\ $^{*}$Universidade Federal Fluminense {UFF} \\Rio de Janeiro, Brasil}
\degree{Licenciado en Ciencia de la Computación}
\faculty{Facultad de Matemática y Computación}
\date{Fecha \\  Diciembre 2023 \\\vspace{0.25cm}\href{https://github.com/deborahfam/Thesis}{github.com/deborahfam/Thesis}}
